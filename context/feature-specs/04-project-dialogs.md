...
Reuse the existing editor layout. Do not modify the navbar behavior. The sidebar should remain unchanged except for the project actions and the mobile dismissal behavior explicitly required by this specification.
