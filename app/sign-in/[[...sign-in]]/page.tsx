        ...
        <div className="flex flex-col justify-center border-b border-surface-border px-8 py-10 lg:w-[44%] lg:border-b-0 lg:border-r lg:px-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-copy-secondary">Design faster with shared clarity.</p>
            </div>
          </div>

          <div className="mt-8 space-y-4 text-sm text-copy-secondary">
            <p className="text-base font-medium text-copy-primary">Start your workspace with a focused flow.</p>
            <ul className="space-y-2">
              <li>• Capture ideas without losing context.</li>
              <li>• Keep specs and design direction aligned.</li>
              <li>• Review and share your work in one place.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-1 items-center justify-center px-4 py-8 sm:px-8 lg:px-10">
          <div className="w-full max-w-md">
            <SignIn 
              ...
              signUpUrl="/sign-up"
              fallback={<div className="text-center text-copy-secondary">Loading sign-in…</div>}
            />
          </div>
        </div>
      </div>
